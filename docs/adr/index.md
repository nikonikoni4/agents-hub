...
- path: `docs/ADR/0001-codex-system-prompt-strategy.md`
...
- updated_at: 2026-05-23
- path: `docs/ADR/0002-agent-bridge-output-and-session-strategy.md`
...
- updated_at: 2026-05-23
- path: `docs/ADR/0003-agent-bridge-architecture-choice.md`
...
- updated_at: 2026-05-23
- path: `docs/ADR/0004-codex-sdk-migration-decision.md`
...
- path: `docs/ADR/0005-multi-agent-message-architecture.md`
...
- path: `docs/ADR/0006-explicit-group-chat-speech.md`
- 状态：decided
...
- updated_at: 2026-05-31
- path: `docs/ADR/0007-agent-token-identity-model.md`
- 状态：decided
...
- path: `docs/ADR/0008-realtime-boundary.md`
- 状态：decided
...
- updated_at: 2026-06-04
- path: `docs/ADR/0009-core-runtime-ssot-choice.md`
- 状态：decided
...
- path: `docs/ADR/0010-agent-context-and-prompt-architecture.md`
- 状态：decided
...
- updated_at: 2026-06-08
- path: `docs/ADR/0011-agent-tool-semantics-and-blocking-rules.md`
- 状态：decided
...
- path: `docs/ADR/0012-mcp-transport-and-platform-migration.md`
- 状态：decided
...
- path: `docs/ADR/0013-prompt-architecture-refactor.md`
- 状态：decided
...
- path: `docs/ADR/0014-agent-hook-boundary.md`
- 状态：decided
