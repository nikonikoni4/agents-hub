...
class TestFinishAgentCall:
    ...
    @pytest.mark.asyncio
    async def test_finish_agent_call_redacts_completion_notification(
        self, mock_group_chat_manager, mock_group_chat
    ):
    ...
    @pytest.mark.asyncio
    async def test_finish_agent_call_to_user_writes_group_chat_message(
        self, mock_group_chat_manager, mock_group_chat
    ):
